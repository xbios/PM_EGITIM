...
const BackendBoxedDashboard = () => import("@/views/backend-boxed/DashboardView.vue");
const BackendBoxedSimple1 = () => import("@/views/backend-boxed/Simple1View.vue");
const BackendBoxedSimple2 = () => import("@/views/backend-boxed/Simple2View.vue");
...
const BackendBlogStoryCover = () => import("@/views/backend/blog/StoryCoverView.vue");

// Backend: e-Learning
const BackendElearningCourses = () => import("@/views/backend/elearning/CoursesView.vue");
const BackendElearningCourse = () => import("@/views/backend/elearning/CourseView.vue");
const BackendElearningLesson = () => import("@/views/backend/elearning/LessonView.vue");

// Backend: Forum
const BackendForumCategories = () => import("@/views/backend/forum/CategoriesView.vue");
const BackendForumTopics = () => import("@/views/backend/forum/TopicsView.vue");
const BackendForumDiscussion = () => import("@/views/backend/forum/DiscussionView.vue");

// Backend: Blocks
const BackendBlocksStyles = () => import("@/views/backend/blocks/StylesView.vue");
const BackendBlocksOptions = () => import("@/views/backend/blocks/OptionsView.vue");
const BackendBlocksForms = () => import("@/views/backend/blocks/FormsView.vue");
const BackendBlocksThemed = () => import("@/views/backend/blocks/ThemedView.vue");
const BackendBlocksApi = () => import("@/views/backend/blocks/ApiView.vue");

// Backend: Elements
const BackendElementsGrid = () => import("@/views/backend/elements/GridView.vue");
const BackendElementsTypography = () => import("@/views/backend/elements/TypographyView.vue");
const BackendElementsIcons = () => import("@/views/backend/elements/IconsView.vue");
const BackendElementsButtons = () => import("@/views/backend/elements/ButtonsView.vue");
const BackendElementsButtonGroups = () => import("@/views/backend/elements/ButtonGroupsView.vue");
const BackendElementsDropdowns = () => import("@/views/backend/elements/DropdownsView.vue");
const BackendElementsTabs = () => import("@/views/backend/elements/TabsView.vue");
const BackendElementsNavigation = () => import("@/views/backend/elements/NavigationView.vue");
const BackendElementsNavigationHorizontal = () => import("@/views/backend/elements/NavigationHorizontalView.vue");
const BackendElementsMegaMenu = () => import("@/views/backend/elements/MegaMenuView.vue");
const BackendElementsProgress = () => import("@/views/backend/elements/ProgressView.vue");
const BackendElementsAlerts = () => import("@/views/backend/elements/AlertsView.vue");
const BackendElementsTooltips = () => import("@/views/backend/elements/TooltipsView.vue");
const BackendElementsPopovers = () => import("@/views/backend/elements/PopoversView.vue");
const BackendElementsModals = () => import("@/views/backend/elements/ModalsView.vue");
const BackendElementsImagesOverlay = () => import("@/views/backend/elements/ImagesOverlayView.vue");
const BackendElementsTimeline = () => import("@/views/backend/elements/TimelineView.vue");
const BackendElementsRibbons = () => import("@/views/backend/elements/RibbonsView.vue");
const BackendElementsAnimations = () => import("@/views/backend/elements/AnimationsView.vue");
const BackendElementsColorThemes = () => import("@/views/backend/elements/ColorThemesView.vue");

// Backend: Tables
const BackendTablesStyles = () => import("@/views/backend/tables/StylesView.vue");
const BackendTablesResponsive = () => import("@/views/backend/tables/ResponsiveView.vue");
const BackendTablesHelpers = () => import("@/views/backend/tables/HelpersView.vue");

// Backend: Forms
const BackendFormsElements = () => import("@/views/backend/forms/ElementsView.vue");
const BackendFormsLayouts = () => import("@/views/backend/forms/LayoutsView.vue");
const BackendFormsInputGroups = () => import("@/views/backend/forms/InputGroupsView.vue");
const BackendFormsPlugins = () => import("@/views/backend/forms/PluginsView.vue");
const BackendFormsEditors = () => import("@/views/backend/forms/EditorsView.vue");
const BackendFormsValidation = () => import("@/views/backend/forms/ValidationView.vue");

// Backend: Plugins
const BackendPluginsImageCropper = () => import("@/views/backend/plugins/ImageCropperView.vue");
const BackendPluginsCharts = () => import("@/views/backend/plugins/ChartsView.vue");
const BackendPluginsCalendar = () => import("@/views/backend/plugins/CalendarView.vue");
const BackendPluginsCarousel = () => import("@/views/backend/plugins/CarouselView.vue");
const BackendPluginsOffcanvas = () => import("@/views/backend/plugins/OffcanvasView.vue");
const BackendPluginsSyntaxHighlighting = () => import("@/views/backend/plugins/SyntaxHighlightingView.vue");
const BackendPluginsRating = () => import("@/views/backend/plugins/RatingView.vue");
const BackendPluginsDialogs = () => import("@/views/backend/plugins/DialogsView.vue");
const BackendPluginsNotifications = () => import("@/views/backend/plugins/NotificationsView.vue");
const BackendPluginsGallery = () => import("@/views/backend/plugins/GalleryView.vue");

// Backend: Layout
const BackendLayoutPageDefault = () => import("@/views/backend/layout/page/DefaultView.vue");
const BackendLayoutPageFlipped = () => import("@/views/backend/layout/page/FlippedView.vue");
const BackendLayoutDarkModeOn = () => import("@/views/backend/layout/dark-mode/OnView.vue");
const BackendLayoutDarkModeOff = () => import("@/views/backend/layout/dark-mode/OffView.vue");
const BackendLayoutDarkModeSystem = () => import("@/views/backend/layout/dark-mode/SystemView.vue");
const BackendLayoutMainContentFullWidth = () => import("@/views/backend/layout/main-content/FullWidthView.vue");
const BackendLayoutMainContentNarrow = () => import("@/views/backend/layout/main-content/NarrowView.vue");
const BackendLayoutMainContentBoxed = () => import("@/views/backend/layout/main-content/BoxedView.vue");
const BackendLayoutHeaderFixedLight = () => import("@/views/backend/layout/header/FixedLightView.vue");
const BackendLayoutHeaderFixedDark = () => import("@/views/backend/layout/header/FixedDarkView.vue");
const BackendLayoutHeaderStaticLight = () => import("@/views/backend/layout/header/StaticLightView.vue");
const BackendLayoutHeaderStaticDark = () => import("@/views/backend/layout/header/StaticDarkView.vue");
const BackendLayoutSidebarMini = () => import("@/views/backend/layout/sidebar/MiniView.vue");
const BackendLayoutSidebarLight = () => import("@/views/backend/layout/sidebar/LightView.vue");
const BackendLayoutSidebarDark = () => import("@/views/backend/layout/sidebar/DarkView.vue");
const BackendLayoutSidebarHidden = () => import("@/views/backend/layout/sidebar/HiddenView.vue");
const BackendLayoutSideOverlayVisible = () => import("@/views/backend/layout/side-overlay/VisibleView.vue");
const BackendLayoutSideOverlayHoverMode = () => import("@/views/backend/layout/side-overlay/HoverModeView.vue");
const BackendLayoutSideOverlayNoPageOverlay = () => import("@/views/backend/layout/side-overlay/NoPageOverlayView.vue");
const BackendLayoutLoaders = () => import("@/views/backend/layout/LoadersView.vue");
const BackendLayoutApi = () => import("@/views/backend/layout/ApiView.vue");

// Backend: Generic Pages
const BackendPagesGenericBlank = () => import("@/views/backend/pages/generic/BlankView.vue");
const BackendPagesGenericBlankBlock = () => import("@/views/backend/pages/generic/BlankBlockView.vue");
const BackendPagesGenericSearch = () => import("@/views/backend/pages/generic/SearchView.vue");
const BackendPagesGenericProfile = () => import("@/views/backend/pages/generic/ProfileView.vue");
const BackendPagesGenericProfileEdit = () => import("@/views/backend/pages/generic/ProfileEditView.vue");
const BackendPagesGenericInvoice = () => import("@/views/backend/pages/generic/InvoiceView.vue");
const BackendPagesGenericPricingPlans = () => import("@/views/backend/pages/generic/PricingPlansView.vue");
const BackendPagesGenericFaq = () => import("@/views/backend/pages/generic/FaqView.vue");
const BackendPagesGenericTeam = () => import("@/views/backend/pages/generic/TeamView.vue");
const BackendPagesGenericContact = () => import("@/views/backend/pages/generic/ContactView.vue");
const BackendPagesGenericSupport = () => import("@/views/backend/pages/generic/SupportView.vue");
const BackendPagesGenericInbox = () => import("@/views/backend/pages/generic/InboxView.vue");
const BackendPagesGenericSidebarMiniNav = () => import("@/views/backend/pages/generic/SidebarMiniNavView.vue");
